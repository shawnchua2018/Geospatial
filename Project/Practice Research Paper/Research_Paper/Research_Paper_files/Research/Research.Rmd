...
eqn represents the value of the output variable at the coordinate location i , eqn  denotes the coordinates of the i-th point in space and β_k (u_i,u_v) is a realization of the continuous functions at point i (Brunsdon et al., 1999). 
