...
#test[10:18]
corrplot(cor(test[, 2:13]), diag = FALSE, order = "AOE", tl.pos = "td", tl.cex = 0.5, method = "number", type = "upper")
...
resale_flat.mlr1 <- lm(formula = resale_price ~ remaining_lease_nearest_year + flat_type_code + mrt_count + pri_school_count + sec_school_count + community_center_count + supermarket_count + preschool_count + hawker_count + mall_count, data=sf_resale_flat)
